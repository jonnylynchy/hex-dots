...
/***/ function(module, exports, __webpack_require__) {
	...
	var alertify = __webpack_require__(2);
	...
	var AlottaDotties = function () {
		...
		_createClass(AlottaDotties, [{
			...
			value: function showStartUpMessages() {
				var messages = this.messages.startupMessages,
				    messageDelay = 3500,
				    showDelay = 0;

				alertify.logPosition("top left");
				messages.forEach(function (message) {
					setTimeout(function showStartUpMessage() {
			...
			value: function attachMobileEvents() {
				...
				this.stage.addEventListener('touchmove', function dotTouchMove(e) {
					var currentX = e.changedTouches[0].clientX - this.stage.offsetLeft;
					var currentY = e.changedTouches[0].clientY - this.stage.offsetTop;
			...
			key: "addDotMobileEvents",
			value: function addDotMobileEvents(dot) {
				// Mobile Test
				dot.addEventListener('touchenter', function dotTouchEnter(e) {
					console.log('mobile touch enter');
					e.preventDefault();
				}.bind(this), false);

				dot.addEventListener('touchstart', function dotTouchStart(e) {
				...
				dot.addEventListener('touchend', function dotTouchEnd(e) {
				...
				dot.addEventListener('mouseover', function dotTouchOver(e) {
			...
			value: function addDotEvents(dot) {
				dot.addEventListener('mousedown', function dotMouseDown(e) {
					var y = e.target.offsetTop + this.dotSize / 2,
				...
				dot.addEventListener('mouseenter', function dotMouseEnter(e) {
					if (this.mouseIsDown) {
						var y = e.target.offsetTop + this.dotSize / 2,
						    x = e.target.offsetLeft + this.dotSize / 2,
						...
						if (y > lastDotRealY + (fullDot + paddingAdjustment) || y < lastDotRealY - (fullDot + paddingAdjustment)) {
							...
							if (!this.targetGroup.includes(e.target)) this.targetGroup.push(e.target);
			...
			key: "timedEvent",
			value: function timedEvent(dot, funcName) {}
		}, {
			key: "addAnimation",
			...
			value: function areDotsTheSame(dots) {
				var dotColors = dots.reduce(function reduceDotColors(dotClasses, dot) {
			...
			value: function doDotsFormSquare(dots) {
				...
				var vectorArray = dots.map(function mapDotPositions(dot) {
					return {
						top: dot.offsetTop,
						left: dot.offsetLeft
					};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "font/067a581cfb5b2394a8e65001e7c72cb6.eot";

/***/ },
/* 8 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "font/0196a5cfbba5a9a9df2c557763effdc0.woff";

/***/ },
/* 9 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "font/eccb7a74720fc377b60d6b2110530fd9.ttf";

/***/ },
/* 10 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "DejaVuSans.svg";

/***/ },
/* 11 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "dotties-robot.svg";
