	...
	var AlottaDotties = function () {
					...
					_createClass(AlottaDotties, [{
									...
									value: function init() {
													...
													this.messages = {
																	startupMessages: ["Would you like to play a game?", "Click and drag a dot to connect to other dots of the same color.", "You can chain dots together for extra points.", "If you connect 4 as a square, all dots of the same color will vanish!", "Ready? Go!"],
																	successMessage: "Nice.",
									...
									value: function attachEvents() {
													this.stage.addEventListener('mouseup', function stageMouseUp(e) {
																	if (this.targetGroup.length > 1 && this.mouseIsDown && this.areDotsTheSame(this.targetGroup)) {
																					...
																					if (!isSquare) {
																									var success = msg + ' You got ' + num + ' dotties!';
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "f48e5b0fa8801b293835270150a8cf0a.svg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "ed3fd769c98c31b27fd4d4fbbb5d0f65.svg";
